...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'dbecas');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'BACKUP-becas'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE", 'backup-dbecas-20180518_173503.sql.gz'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
...
echo '<a href="../views/dashboard/import_export_database.php">Regresar</a>';
